...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 relative">
      ...
      <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-amber-300/10 to-transparent -z-10" />
        ...
        <div className="flex flex-col items-center justify-center gap-8 mb-20">
            <div className="flex flex-col sm:flex-row justify-center gap-6 w-full sm:w-auto">
                 <motion.a 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center gap-3 px-8 py-4 bg-slate-900 border border-slate-800 rounded-full text-slate-300 hover:text-white hover:border-amber-300/50 transition-all duration-300 group w-full sm:w-auto"
                >
                ...
                <motion.button 
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center gap-3 px-8 py-4 bg-slate-900 border border-slate-800 rounded-full text-slate-300 hover:text-white hover:border-amber-300/50 transition-all duration-300 relative overflow-hidden group w-full sm:w-auto"
                >
                    {copied ? <Check size={20} className="text-amber-400" /> : <Phone size={20} className="text-amber-300" />}
                    ...
                    {copied && (
                        <motion.span 
                            ...
                            exit={{ opacity: 0 }}
                            className="absolute -top-8 left-1/2 -translate-x-1/2 bg-amber-400 text-black text-xs px-2 py-1 rounded"
                        >
                            Copied!
                        </motion.span>
                    )}
